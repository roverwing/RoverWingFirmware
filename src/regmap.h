...
#define FLAG_ANALOG (0x01)
#define FLAG_SONAR_BITMASK (0x01<<1)
#define FLAG_SERVO (0x01<<2)
#define FLAG_MOTOR1_PID (0x01<<3)
#define FLAG_MOTOR2_PID (0x01<<4)
#define FLAG_ENC_RESET (0x01<<5)
#define FLAG_MOTOR_MODE (0x01<<6)
#define FLAG_MOTOR_POWER (0x01<<7)
#define FLAG_MOTOR_TARGET (0x01<<8)
#define FLAG_IMU_CONFIG (0x01<<9)
#define FLAG_MAG_CONFIG (0x01<<10)
#define FLAG_GPS_CONFIG (0x01<<11)
#define FLAG_LOW_VOLTAGE (0x01<<12)
#define FLAG_NUM_PIXELS (0x01<<13)
#define FLAG_PIXEL_CONFIG (0x01<<14)
#define FLAG_PIXEL_COLORS (0x01<<15)
//composite flags
